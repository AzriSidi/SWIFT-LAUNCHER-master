...
public class DeviceInfo {
    ...
    public DeviceInfo(final Context context){
        ...
        mPhoneState = new PhoneState(this.activity,this.context);
    ...
    public String getSimState(){
        ...
        if(simCard == "Ready"){
            simState = "";
            //tel.listen(new PhoneState(activity, context), PhoneStateListener.LISTEN_SIGNAL_STRENGTHS);
    ...
    private void registerPhoneServiceStateListener() {
        ...
        tm.listen(mPhoneState, PhoneStateListener.LISTEN_SIGNAL_STRENGTHS| PhoneStateListener.LISTEN_DATA_ACTIVITY);
        Log.d(TAG,"registerPhoneServiceStateListener");
    }

    public void unRegisterPhoneServiceStateListener() {
        TelephonyManager tm = (TelephonyManager) context
                .getSystemService(Context.TELEPHONY_SERVICE);
        tm.listen(mPhoneState, PhoneStateListener.LISTEN_NONE);
