package com.plamera.tmswiftlauncher.AppList;
...
public class GridFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lv.setHorizontalSpacing(convertDpToPixels(40, getActivity()));
        lv.setVerticalSpacing(convertDpToPixels(40, getActivity()));
     ...
     * Subclasses should override. Subclasses can dial
     ...
     * shown, dial this method to supply the text it should use.
     */
